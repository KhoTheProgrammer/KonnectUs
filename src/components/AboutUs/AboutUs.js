  ...
  return (
    <div>
      ...
      <div>
        ...
        >
          <div  className=" bg-white w-[60%] h-[675px] ml-[100px] p-[12px]   mt-[50px] rounded-[80px] rounded-b-none cursor-default">
            <h1 className=" text-green-500 text-[30px] font-bold flex justify-center items-center tracking-widest">
              About Us
            </h1>
            <p>
